...
public class ImageIntegrationTests  extends ElasticsearchIntegrationTest {
    ...
    public void test_index_search_image() throws Exception {
        ...
        ImageQueryBuilder imageQueryBuilder2 = new ImageQueryBuilder("img").feature(FeatureEnum.CEDD.name()).image(imgToSearch).boost(4.0f);
        ...
        assertThat("First should be exact match and has score 2", searchResponse2.getHits().getMaxScore(), equalTo(8.0f));
        assertImageScore(hits2, nameToSearch, 8.0f);
